...
public class PacketEntity extends TypedPacketEntity {
    ...
    public final EntityPositionHistory positionHistory = new EntityPositionHistory();
    ...
    public void onMovement(boolean tickingReliably) {
        ...
        positionHistory.record(GrimAPI.INSTANCE.getTickManager().currentTick, getPossibleCollisionBoxes());
    }
