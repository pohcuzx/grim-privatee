...
public class MessageUtil {
    ...
    public @NotNull Component miniMessage(@NotNull String string) {
        String prefix = "&bGrim &8»";
        if (GrimAPI.INSTANCE.getConfigManager().getConfig() != null) {
            prefix = GrimAPI.INSTANCE.getConfigManager().getConfig().getStringElse("prefix", prefix);
        }
    ...
    public Component getParsedComponent(Sender sender, String key, String fallbackText) {
        ...
        if (GrimAPI.INSTANCE.getConfigManager().getConfig() != null) {
            message = GrimAPI.INSTANCE.getConfigManager().getConfig().getStringElse(key, fallbackText);
        }
