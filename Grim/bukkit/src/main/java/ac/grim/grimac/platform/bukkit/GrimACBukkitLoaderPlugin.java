...
import ac.grim.grimac.platform.bukkit.flagmenu.BukkitFlagMenuHandler;
...
public final class GrimACBukkitLoaderPlugin extends JavaPlugin implements PlatformLoader {
    ...
    private final BukkitFlagMenuHandler flagMenuHandler;
    ...
    public GrimACBukkitLoaderPlugin() {
        ...
        this.flagMenuHandler = new BukkitFlagMenuHandler(this);
        GrimAPI.INSTANCE.setFlagMenuHandler(flagMenuHandler);
    }
